...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareBtnPA.setOnClickListener {
            ...
            startActivity(Intent.createChooser(shareIntent, "Chia sẻ tệp nhạc!!"))
...
//Important Function
    ...
    private fun showBottomSheetDialog(){
        ...
        dialog.findViewById<LinearLayout>(R.id.min_15)?.setOnClickListener {
            Toast.makeText(baseContext,  "Nhạc sẽ dừng sau 15 phút", Toast.LENGTH_SHORT).show()
        ...
        dialog.findViewById<LinearLayout>(R.id.min_30)?.setOnClickListener {
            Toast.makeText(baseContext,  "Nhạc sẽ dừng sau 30 phút", Toast.LENGTH_SHORT).show()
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.purple_500))
            min30 = true
        ...
        dialog.findViewById<LinearLayout>(R.id.min_60)?.setOnClickListener {
            Toast.makeText(baseContext,  "Nhạc sẽ dừng sau 60 phút", Toast.LENGTH_SHORT).show()
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.purple_500))
            min60 = true
